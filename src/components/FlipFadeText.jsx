...
const Word = memo(function Word({
  ...
  return (
    <motion.div
      className={cn(
        "flex flex-wrap justify-center gap-[0.02em] font-serif tracking-tight text-slate-900 text-3xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.12]",
        textClassName
      )}
      initial="initial"
      animate="animate"
...
export function FlipFadeText({
  ...
  return (
    <div className={cn("flex items-center justify-center min-h-[70px] sm:min-h-[100px]", className)}>
      <div className="relative flex items-center justify-center text-center" style={{ perspective: "1000px" }}>
