        ...
        <div className="min-h-screen w-full bg-[#FFEBF2] flex flex-col items-center justify-center p-6 text-center font-sans select-none">
          <div className="bg-white max-w-sm w-full rounded-3xl p-6 shadow-2xl border border-rose-100 space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 bg-[#FF2E79] hover:bg-rose-600 text-white font-extrabold text-xs uppercase tracking-wider rounded-full shadow-lg shadow-rose-300 cursor-pointer active:scale-95 transition-all"
            >
              Open Live Round Radar
            </button>
          </div>
        </div>
      );
