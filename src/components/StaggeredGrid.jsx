...
export function StaggeredGrid({
  ...
  // Mix strictly of Indian Humans + Cartoon/Illustrated Characters
  const indianAndCartoonImages = [
    '/avatars/ananya.jpg', // Indian Human
    'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80', // 3D Cartoon Character
    '/avatars/aarav.jpg', // Indian Human
    'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=600&q=80', // Indian Human Student
    '/avatars/zoya.jpg', // Indian Human
    'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=600&q=80', // Cartoon Portrait
    '/avatars/kabir.jpg', // Indian Human
    'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80', // Indian Male Student
    '/avatars/rhea.jpg', // Indian Human
    'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&w=600&q=80', // Indian Female
    'https://images.unsplash.com/photo-1583394838336-acd977736f90?auto=format&fit=crop&w=600&q=80', // Indian Male
    'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=600&q=80', // Indian Campus Group
    'https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?auto=format&fit=crop&w=600&q=80', // Indian Cafe Friends
    'https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fit=crop&w=600&q=80', // Indian College Discussion
    'https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&w=600&q=80', // Indian Group Hangout
  ];
      ...
      <section className="grid place-items-center w-full relative px-2 sm:px-4">
        ...
        >
          {mixedGridItems.map((item, i) => {
            if (item === 'BENTO_GROUP') {
              if (!activeBentoItems || activeBentoItems.length === 0) return null;
